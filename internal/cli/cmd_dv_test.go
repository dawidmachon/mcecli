...
func TestDvSendPositionalID(t *testing.T) {
	var bodies []string
	fakeSFMC(t, dvSoapRoute(&bodies, "OK",
		`<Results xsi:type="Send"><ID>61504</ID><EmailName>automation_events_email</EmailName><FromName>PMI Automation Monitoring</FromName></Results>`))
...
func TestDvSendSubscriberKeyRefused(t *testing.T) {
	var bodies []string
	fakeSFMC(t, dvSoapRoute(&bodies, "OK",
		`<Results xsi:type="Send"><ID>61504</ID></Results>`))
